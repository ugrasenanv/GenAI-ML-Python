"""Example 13: Menu Driven Program Using Functions

Implementation Details:
- Demonstrates function-based programming approach
- Implements multiple mathematical operations as separate functions
- Uses while loop for continuous menu display
- Includes error handling with try-except blocks
- Shows modular programming concepts

Functions Implemented:
1. Print first 10 natural numbers
2. Calculate sum of N natural numbers
3. Reverse a number using digit extraction
4. Count digits in a number
5. Check if number is palindrome
6. Generate Fibonacci series
7. Calculator with basic operations

Concepts: Functions, loops, conditionals, error handling, modular design
"""
